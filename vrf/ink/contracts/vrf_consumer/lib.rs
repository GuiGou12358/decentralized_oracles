...
pub mod vrf_consumer {
    ...
    impl rollup_anchor::EventBroadcaster for VrfClient {
    ...
    mod e2e_tests {
        ...
        async fn test_receive_reply(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let get_last_value = build_message::<VrfClientRef>(contract_id.clone())
        ...
        async fn test_meta_tx_rollup_cond_eq(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let prepare_meta_tx = build_message::<VrfClientRef>(contract_id.clone())
            ...
            let meta_tx_rollup_cond_eq = build_message::<VrfClientRef>(contract_id.clone())
